...
@Data
public class WildcardSearchItem extends SearchItem {
	...
	public WildcardSearchItem(List<String> fields, String value, ElasticsearchConfiguration configuration) {
		super();
		this.fields = fields;
		this.value = value;
	...
	public SingleQuery createSearchParameter() {
		...
		if (StringUtils.isNotEmpty(this.getValue()) && configuration != null) {
			...
			query.setQuery_string(matchQuery);
		}
		return query;
	}
