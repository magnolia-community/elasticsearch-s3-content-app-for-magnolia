...
public class ParamsAdapter {
	...
	public Params fillParamsSearch(Component component) {
		...
		if (component instanceof Upload) {
			...
			if (((com.whitelabel.app.generic.ui.FileUploader) upload.getReceiver()).getFile() != null
					&& ((com.whitelabel.app.generic.ui.FileUploader) upload.getReceiver()) != null
					&& upload.getId() != null) {
				File fileContent = ((com.whitelabel.app.generic.ui.FileUploader) upload.getReceiver()).getFile();
