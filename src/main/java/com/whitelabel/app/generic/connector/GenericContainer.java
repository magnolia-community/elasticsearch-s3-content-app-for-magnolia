 ...
 *
 */
package com.whitelabel.app.generic.connector;
...
import com.whitelabel.app.event.BaseItemSetChangeEvent;
...
//	    Create Generic Container
	...
	public void createConnection(Params params) throws Exception {
		if (serviceContainer.getCustomContainer().getContentConnector() == null || serviceContainer.getCustomContainer().getContentConnector().get() == null) {
			createCustomContainer(params);
		}
